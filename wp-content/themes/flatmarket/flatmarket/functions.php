...
$theme_options = unserialize( ( get_option('FLATMARKET_PANEL') ) );
...
function flatmarket_setup() {
	...
	register_nav_menus( array(
            ...
            'left' => __('Left Categories Menu', 'flatmarket'),
...
function flatmarket_scripts() {
	...
	wp_enqueue_script('flatmarket-script', get_template_directory_uri() . '/js/template.js', array('jquery', 'flatmarket-bootstrap', 'flatmarket-easing', 'flatmarket-flexslider', 'flatmarket-parallax', 'flatmarket-select2', 'owl-carousel'), '1.0', true);

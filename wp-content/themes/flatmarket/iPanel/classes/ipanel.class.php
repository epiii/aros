...
if (!class_exists('IPANEL')) {
    ...
    class IPANEL
    {
        ...
        public function getOption($id = '')
        {
            ...
            //echo @unserialize((get_option($this->args['ID'])));
        ...
        { 
            ...
            if ( false === ( get_transient( 'theme_googleFonts'  ) ) ) {
              
                $response = wp_remote_get(
                    'https://www.googleapis.com/webfonts/v1/webfonts?sort=popularity&key=AIzaSyBFSLcqgaFj_DgnHM-_Xfh3sOlxfxl7SOI',
                    array(
                        'sslverify' => false
                    )
                );
                ...
                if (!is_wp_error($response)) {
                    ...
                    set_transient('theme_googleFonts', serialize($fonts_list), 60 * 60 * 24 * 2); // Cache 2 days

...
$ipanel_flatmarket_option[] = array(
	"name" => "Center header logo",
	"id" => "header_logo_center",
	"std" => false,
	"field_options" => array(
		"box_label" => "Check Me!"
	),
	"desc" => "This option show your header logo on center and hide header info text and drop down cart. Useful for corporate website.",
	"type" => "checkbox",
);

$ipanel_flatmarket_option[] = array(
	"name" => "Show WPML language switcher in header",
...
$ipanel_flatmarket_option[] = array(
	"name" => "Show WPML currency switcher in header",
...
$ipanel_flatmarket_option[] = array(
	"name" => "Alternate background colors in Left MegaMenu items",
	"id" => "megamenu_strip",
	"std" => false,
	"field_options" => array(
		"box_label" => "Check Me!"
	),
	"desc" => "Left Megamenu items will have semitransparent alternate backgrounds effect",
	"type" => "checkbox",
);
$ipanel_flatmarket_option[] = array(
...
$ipanel_flatmarket_option[] = array(
	"name" => "Products per page limit",
	"id" => "shop_woocommerce_products_per_page",
	"std" => "10",
	"desc" => "How many products will be displayed on shop/category page",
	"type" => "text",
);
$ipanel_flatmarket_option[] = array(
...
$ipanel_flatmarket_option[] = array(
	"name" => "Products per row (columns count) in homepage sliders",
	"id" => "shop_products_per_row_slider",
	"std" => "5",
	"options" => array(
		"5" => "5",
		"4" => "4",
...
$ipanel_flatmarket_option[] = array(
	"name" => "Show WooCommerce search form in header",
...
$ipanel_flatmarket_option[] = array(
	"name" => "Show search by category selectbox in WooCommerce ajax search field",
	"id" => "woocommerce_show_cat_search",
	"std" => true,
	"field_options" => array(
		"box_label" => "Check Me!"
	),
	"desc" => "Ajax Search plugin should be enabled",
	"type" => "checkbox",
);
$ipanel_flatmarket_option[] = array(
